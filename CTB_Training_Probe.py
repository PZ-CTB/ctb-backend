...
def get_vector(dateStart, dateEnd, ageLimit = 10):
  ...
  # data set consists of 3 values: High, Avg, Low
...
#length = get_vector_columns(dateStart, dateEnd) #returns you no of collumns target vector should have to accomodate all the data
#noRows = 8
#vectors = np.zeros((noRows, length))
#y_values = np.zeros((noRows, length))

#vectors, y_values = get_vectorS(dateStart, dateEnd, noRows) #returns noRows = 8 vectors
